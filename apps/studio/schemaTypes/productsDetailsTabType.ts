...
export const productsDetailsTabType = defineType({
    name: 'productsDetailsTabType',
    title: 'Products Details Tab',
    type: 'object',
    fields: [
        {
            name: 'tagline',
            ...
            description: 'A short tagline to introduce the products details tab section',
        },
        {
            name: 'title',
            title: 'Title',
            ...
            validation: (rule) => rule.required(),
            description: 'Main heading for the products details tab section',
        },
        {
            name: 'description',
            title: 'Description',
        ...
        },
        {
                            ...
                            fields: [
                                {
                                    ...
                                    description: 'Image representing the product detail. Used as poster when video is present.'
                                },
                                {
                                    name: 'video',
                                    title: 'Video',
            ...
            description: 'Tabs to showcase different product details'
        },
        {
    ...
    preview: {
        ...
        prepare(selection: { title?: any[]; media?: any }) {
            ...
            return {
                title: plainTitle || 'Products Details Tab',
                subtitle: 'Products Details Tab',
                media: media,
            }
        },
    },
