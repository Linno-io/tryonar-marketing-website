...
export default function TestimonialSection({data}: {data: SuccessStoriesSection}) {
    const {
        title,
        description,
        stories,
        ...
        <section className="relative pt-24 pb-24 md:pb-0 bg-[#F8F8F9] overflow-hidden z-10">
            ...
            <Container size="xl" className="relative z-10">
                ...
                <div className="text-center">
                    ...
                    {
                        description && (
                            <p className="text-gray-500 text-lg mx-auto">{description}</p>
                        )
                    }
                </div>
                ...
                >
                    ...
                    {stories?.map((item : any, i: number) => (
                        ...
                        >
                            ...
                            {/* Quote */}
                            <p className="text-[#0C0020] text-[15px] leading-relaxed mb-6">&ldquo;{item.review}&rdquo;</p>
