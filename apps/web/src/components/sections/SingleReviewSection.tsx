            ...
            <section className='single-review-section bg-[#F8F8F9] pt-2.5 overflow-hidden'>
                <Container withBorder={true} padding={false} className='pb-27.5'>
                    <div className="w-full py-22.5 single-review-container relative border-y border-[#ECEDF1] bg-white bg-[url('/dot-bg.png')] bg-no-repeat bg-center bg-cover shadow-[0_20px_25px_-5px_rgba(0,0,0,0.04),0_8px_10px_-6px_rgba(0,0,0,0.05)] flex items-center justify-center flex-col text-center">
                        ...
                        {
                            data.review && (
                                <blockquote className='text-[#2A2730] text-[30px] text-medium leading-normal mt-6 max-w-full w-140'>
                                    “{
                        ...
                        <div className='mt-6 flex flex-col items-center justify-center'>
                            ...
                            />
                            <p className='text-[#221A4F] text-base font-semibold mt-3.5'>{data.author.name}</p>
                            <p className='text-[#646464] text-sm '>{data.author.position}</p>
                        </div>
