...
const ShieldIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="22" className="w-[16px] h-[19px] md:w-[19px] md:h-[22px]" viewBox="0 0 19 22" fill="none">
...
const SupportIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" className="w-[15px] h-[17px] md:w-[16px] md:h-[20px]" viewBox="0 0 16 20" fill="none">
...
const LockIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" className="w-[15px] h-[17px] md:w-[18px] md:h-[20px]" viewBox="0 0 18 20" fill="none">
...
export default function CTASection({ data }: CTAProps) {
    ...
    return (
        <section className="relative overflow-hidden bg-[#050308] xl:pb-27 lg:pb-20 md:pb-15 pb-13">
                                ...
                                {stats.map((stat, index) => {
                                    ...
                                    return (
                                        <div key={index} className="flex items-center gap-2.5 text-[#e7e5ea]">
                                            {Icon}
                                            <span className="text-[15px] md:text-base">{stat.label}</span>
                                        </div>
                                    )
                                })}
                            </div>
