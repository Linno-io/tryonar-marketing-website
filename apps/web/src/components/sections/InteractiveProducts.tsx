...
const BEFORE_IMAGE = '/landing-hero-section/before-img.webp'
...
const CATEGORIES: ProductCategory[] = [
    {
        ...
        colors: [
            { name: 'Petal',    hex: '#E8A0A0', image: '/landing-hero-section/lipstick-petal.webp' },
            { name: 'Ceremony', hex: '#C0626B', image: '/landing-hero-section/lipstick-ceremony.webp' },
            { name: 'Plum',     hex: '#7B3355', image: '/landing-hero-section/lipstick-plum.webp' },
            { name: 'Brick',    hex: '#8B3A2A', image: '/landing-hero-section/lipstick-brick.webp' },
            { name: 'Noir',     hex: '#2A1420', image: '/landing-hero-section/lipstick-noir.webp' },
        ],
    },
    {
        id: 'blush',
...
const InteractiveProducts = ({ priority = false }: Props) => {
    ...
    const handleCategorySelect = useCallback((id: string) => {
        ...
        if (idx >= 0) { setCycleIdx(idx); pauseAndResume() }
    }, [pauseAndResume])
        ...
        return (
            ...
            >
                <div className="relative w-full h-full rounded-lg overflow-hidden">
                    <Image src={cat.thumbnail} alt={cat.label} fill sizes="50px" style={{ objectFit: 'cover' }} />
                </div>
            </button>
        )
    })
            ...
            <div className="relative w-full" style={{ maxWidth: 370 }}>
                ...
                >
                    ...
                    <div
                        ...
                        style={{ left: `${dividerPos}%`, top: '45%', transform: 'translate(-50%, -50%)', zIndex: 4 }}
                                ...
                                {activeCategory.colors.map((color, i) => (
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            style={{ fontSize: 9, opacity: activeColorIndex === i ? 1 : 0.6 }}
                                        >
                                            {color.name}
                                        </span>
                                    </button>
                    ...
                    {showIframe && (
                        <div className="absolute inset-0 bg-black z-20 overflow-hidden" style={{borderRadius: '16px 16px  0 0'}}>
                            <button
                                ...
                                className="absolute top-2.5 left-3 z-30 w-9 h-9 flex items-center justify-center bg-black/10 hover:bg-black/20 backdrop-blur-sm rounded-full transition-all cursor-pointer"
                            >
...
export default memo(InteractiveProducts)
