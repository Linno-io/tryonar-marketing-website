        ...
        <section className="bg-[#ffffff]font-sans text-[#1f2937] border-b border-[#EEEDF2]">
            <Container size="xl" withBorder={true} className='py-8 max-[575px]:py-6 md:py-24 !px-[10px]'>
                <div className="text-center mb-6 lg:mb-10">
                    ...
                    <h2 className="text-3xl max-[575px]:text-2xl md:text-5xl font-extrabold tracking-tight mb-3.5 max-[575px]:mb-2">
                ...
                {/* Tabs Selection */}
                <div className="flex flex-wrap justify-center gap-3 max-[575px]:gap-2 mb-10 max-[575px]:mb-6">
                    {tabs.map((tab) => (
                        <button
                            key={tab._key}
                ...
                <div className="bg-[#f8f8f9] rounded-2xl md:rounded-[3rem] p-2.5 relative">
                    ...
                    >
                            ...
                            <div className="px-14 max-[575px]:px-4 py-10 max-[575px]:py-6 lg:py-8 min-w-full lg:min-w-125 max-w-full">
                                ...
                                <div className="space-y-4 lg:space-y-7 mt-10 max-[575px]:mt-6">
                                    ...
                                    <ul className="space-y-2 lg:space-y-5">
                                        {current.features.map((feature: string, i: number) => (
                                            <li key={i} className="flex items-center gap-4 text-[#3e3e42]">
